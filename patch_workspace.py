...
old_meta = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'description' + SQ + ': description or ' + SQ + 'Data backup' + SQ
new_meta = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'workspace_id' + SQ + ': workspace_id, ' + SQ + 'description' + SQ + ': description or ' + SQ + 'Data backup' + SQ
f = f.replace(old_meta, new_meta)

# Also update CLI variant
old_meta2 = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'description' + SQ + ': description or ' + SQ + 'CLI data backup' + SQ
new_meta2 = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'workspace_id' + SQ + ': workspace_id, ' + SQ + 'description' + SQ + ': description or ' + SQ + 'CLI data backup' + SQ
...
old_meta3 = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'description' + SQ + ': description or ' + SQ + 'CLI data backup' + SQ
new_meta3 = SQ + 'version' + SQ + ': ' + SQ + 'v1.20.0' + SQ + ', ' + SQ + 'workspace_id' + SQ + ': workspace_id, ' + SQ + 'description' + SQ + ': description or ' + SQ + 'CLI data backup' + SQ
